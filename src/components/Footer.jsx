...
import img1 from "../assets/img/appstore.png";
import img2 from "../assets/img/playstore.png";

export default function Footer() {
  return (
    <div className="footer">
      <div className="footer__sec__container">
        <div className="footer__sec__container__left">
          <div className="input__container">
            ...
            <div className="input__container__input">
            ...
            <div className="svg1">
              ...
              >
                <g
                  ...
                  transform="translate(10201.156 -16892.176)"
                >
                  <g id="mail" transform="translate(-10201.156 16892.176)">
            ...
            <div className="svg1">
              ...
              >
                <path
                  ...
                  transform="translate(-3.991 -4.002)"
                />
              </svg>
            </div>
            <div className="input__container__input">
        ...
        <div className="footer__sec__container__right">
          <div className="footer__sec__container__right__content">
            <div className="footer__sec__container__right__content__data">
              <div className="footer__sec__container__right__content__data__svg">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="31.378"
                  height="31.438"
                ...
                >
                  <g
                    ...
                    transform="translate(9433.847 -16791.521)"
                  >
                    <path
                      id="phone"
                      d="M32.486,24.787v4.582a3.055,3.055,0,0,1-3.329,3.055,30.225,30.225,0,0,1-13.18-4.689,29.782,29.782,0,0,1-9.164-9.164A30.225,30.225,0,0,1,2.124,5.329,3.055,3.055,0,0,1,5.164,2H9.745A3.055,3.055,0,0,1,12.8,4.627a19.61,19.61,0,0,0,1.069,4.292,3.055,3.055,0,0,1-.687,3.223l-1.94,1.94a24.436,24.436,0,0,0,9.164,9.164l1.94-1.94s2.106-1.107,3.223-.687a19.61,19.61,0,0,0,4.292,1.069,3.055,3.055,0,0,1,2.627,3.1Z"
                      transform="translate(-9435.457 16790.021)"
                      fill="none"
                      stroke="#3cb149"
              ...
              <div className="footer__sec__container__right__content__data__text">
            ...
            <div className="footer__sec__container__right__content__data">
              <div className="footer__sec__container__right__content__data__svg">
                ...
                >
                  <g
                    ...
                    transform="translate(9434.04 -16877.156)"
                  >
                    <g id="mail" transform="translate(-9435.344 16873.656)">
                      <path
                        id="Path_11226"
              ...
              <div className="footer__sec__container__right__content__data__text">
                <a href="#">readymaidwebsite@gmail.com</a>
              </div>
            </div>
            <div className="footer__sec__container__right__content__data">
              <div className="footer__sec__container__right__content__data__svg">
      ...
      <div className="footer__btn">
        <button className="footer__submit__btn">Submit</button>
      </div>
      <div className="footer__bottom">
        <div className="footer__bottom__container">
          <div className="footer__bottom__container__logo">
            <svg
              id="Group_4286"
              ...
              width="55"
              height="55"
              viewBox="0 0 102.26 93.104"
            >
              <path
                id="Path_9750"
                data-name="Path 9750"
                d="M577.723,409.672h.053l-17.23-30.358H549.878L562,400.645H549.877l-12.425-21.521-.326.188h-40.17v21.743H485.47v-33.23h7.679l61.612.588a21.4,21.4,0,0,0,9.024-3.142l0,0a25.232,25.232,0,0,0,12.486-22.157c.066-13.234-10.414-25.022-23.747-25.308-23.882-.512-47.781-.24-71.672-.416-3.855-.028-4.989,1.663-4.909,5.233.157,6.993.228,14-.015,20.985-.148,4.259,1.877,5.218,5.612,5.2,22.038-.088,44.078-.034,66.116-.073,3.952-.007,7.954-.751,7.838-5.724-.109-4.657-3.939-5.059-7.687-5.056q-25.643.018-51.287-.038c-3.029,0-6.059,0-9.373,0l.018-9.647c2.9,0,4.487-.026,6.511-.023,19.771.035,39.547-.119,59.311.289,6.708.138,12.09,6.369,12.758,13.045.682,6.818-3.158,13.4-9.739,15.454a37.2,37.2,0,0,1-10.944,1.327h-1l.052.03H476.034v52.1h30.358V388.748h25.589l11.744,21.333h34.461Z"
