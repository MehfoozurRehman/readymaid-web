      ...
      <div className="readymaid_app_card_right">
        <div className="readymaid_app_card_right_card">
          ...
          <div className="readymaid_app_card_right_card_paragraph">
            It is what makes us different from our competitors. A smart App for
            our corporate clients having following features
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>a.</span>Personalized business hub on the App{" "}
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>b.</span> Request additional Human Resource demand just by
            clicking a few tabs
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>c.</span> Get immediate response on the App & Website
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>d.</span>Complete detail of resources on the personalized hub
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>e.</span>Number of Reports just a click away
          </div>
          <div className="readymaid_app_card_right_card_linea">
            <span>f.</span>24/7 dedicated helpline
          </div>
          <div className="readymaid_app_card_right_card_website">
            Readymaid Website
          </div>
          <div className="readymaid_app_card_left_web_para">
            A dedicated personalized business hub at the website having all the
