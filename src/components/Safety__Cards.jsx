...
export default function Safety__Cards() {
  return (
    <div className="Safety__Cards__section">
      <div className="Safety__Cards__section__container">
        <div className="Safety__Card__section__img">
          <svg
        ...
        <div className="Safety__Card__content">
          <div className="Safety__Card__section__heading">Trained Staff</div>
          <div className="Safety__Card__section__text">
