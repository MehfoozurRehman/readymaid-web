...
export default function Benifits() {
        ...
        <div className="benifits__safty__content">
          ...
          <div className="benifits__safty__content__entries">
            <div className="benifits__safty__content__entries__entry">
              <div className="benifits__safty__content__entries__entry_svg"><svg xmlns="http://www.w3.org/2000/svg" width="46.896" height="44.237" viewBox="0 0 56.896 54.237">
 ...
 <div className="benifits__safty__content__entries_heading">Easy availability of staff</div>
 <div className="benifits__safty__content__entries_para">In case the provided resource is on leaves Better treatment at workplace by the client (Company will ensure this)</div>
 ...
 <div className="benifits__safty__content__entries_heading">Provision of back up resource </div>
 <div className="benifits__safty__content__entries_heading22">(subject to availability) </div> 
<div className="benifits__safty__content__entries_para">In case the provided resource is on leaves Better treatment at workplace by the client (Company will ensure this)</div>
 ...
 <div className="benifits__safty__content__entries_heading">Easy availability of staff</div>
  ...
  <div className="benifits__safty__content__entries_heading4" >Security background of the staff will be</div>
  <div className="benifits__safty__content__entries_heading45">Insurance Coverage (At a cost, if resource is willing)</div>
 ...
 <div className="benifits__safty__content__entries_heading">Insurance coverage </div>
 <div className="benifits__safty__content__entries_heading22">(At a cost if client wants to avail)</div> 
