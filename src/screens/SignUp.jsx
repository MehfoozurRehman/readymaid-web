  ...
  return (
    <>
      <div className="signup__jumbotron">
        <img className="signup__jumbotron__img" src={sign} alt="signup" />
      ...
      <div className="signup__jumbotron__buttons">
        <div className="signup__jumbotron__end__content__heading__main">
          <div className="signup__jumbotron__end__content__heading">
            ...
            <div className="signup__jumbotron__end__content__input">
              <div className="signup__jumbotron__end__content__input__button">
                <input
                  className="end_input"
                  type="text"
