...
export default function signup() {
  return (
    ...
    <div className="signup__jumbotron">
      <div className="sigup__jumbotron__img__container">
        <img className="signup__jumbotron__img" src={sign} alt="ff" />
      </div>
      <div className="signup__jumbotron__overlay">
        ...
        <div className="signup__jumbotron__overlay__right">
          <div className="signup__jumbotron__overlay__right_one">
            Welcome back!<span> Login</span>
            </div>
        <div className="signup__jumbotron__overlay__right_content">
          invalid email
        </div>
        <div className="signup_all_second_container_input">
                <input className="inputs" type="Name" placeholder="Name" />
                <input className="input_second" type="Email" placeholder="Email" />
              </div>
              <div className="signup_all_second_container_checkbox">
                <input type="checkbox" />Remember me
                
               <div className="signup_all_second_container_anchor">
                <a href="">Forgot password</a>
               </div>
              </div>
              <div className="signup_all_second_container_buton">
