...
export default function signup() {
  return (
    <>
    <div className="signup__jumbotron">
    <img className="signup__jumbotron__img" src={sign} alt="" />
    <div className="signup__jumbotron__overlay">
      <div className="signup__jumbotron__overlay__content">
        <div className="signup__jumbotron__overlay__left">
          <div className="signup_all_first_container_content_one">
            We provide
          </div>
          <div className="signup_all_first_container_content_two">
            <span>Best Quality Services </span> for you
          </div>
          <div className="signup_all_first_container_content_three">
            Home & office
          </div>
          <div className="signup_all_first_container_content_four">
        ...
        <div className="signup__jumbotron__overlay__right">
          ...
          <div className="signup_all_second_container_checkbox_main">
          <div className="signup_all_second_container_checkbox">
            <input type="checkbox" />
            Remember me
          </div>
          <div className="signup__forgot__password">
            <a className="forgot__anchor" href="">Forgot password</a>
          </div>
          </div>
          <div className="signup_all_second_container_button">
            <button className="buttons">Login</button>
          </div>
          <div className="signup_all_second_container_svg">
            <svg
  ...
  <div className="signup__jumbotron__buttons">
  <div className="signup__jumbotron__end__content__heading__main">
  <div className="signup__jumbotron__end__content__heading">
    <div className="signup__jumbotron__end__content__heading_one">
      Heading here
    </div>
    <div className="signup__jumbotron__end__content__heading_two">
   Readymaid is one stop shop, a marketplace, a palteform to provide services of skilled labors to both consumers & corporations alike. this include provisioning of
    </div>
    <div class="signup__jumbotron__end__content__input">
    <div class="signup__jumbotron__end__content__input__button">
        <input class="end_input" type="text" placeholder="Some thing here......"/>
    ...
    <div className="signup__jumbotron__overlay__button">
